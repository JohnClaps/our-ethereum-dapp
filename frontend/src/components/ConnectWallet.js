...
import metamaskLogo from "./images/metamaskLogo.png"; // Ensure the Metamask logo image is imported
import excavatorIcon from "./images/excavatorIcon.png"; // Import the excavator icon image
